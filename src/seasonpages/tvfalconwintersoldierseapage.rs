...
#[component]
pub fn TVFalconWinterSoldierSeaPage() -> impl IntoView {
    ...
    view! {
        <div class="seaMainDiv">
            <h1 class="seaH1">The Falcon And The Winter Soldier</h1>
...
async fn fetch_episodes() -> Result<Vec<Episode>, Error> {
    let response = reqwest::get("http://10.0.4.41:7777/falconwintersoldier").await?;
