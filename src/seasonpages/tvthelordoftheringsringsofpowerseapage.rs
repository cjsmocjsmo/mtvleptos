...
#[component]
pub fn TVTheLordOfTheRingsRingsOfPowerSeaPagePage() -> impl IntoView {
    ...
    view! {
        <div class="seaMainDiv">
            <h1 class="seaH1">The Lord Of The Rings Rings Of Power</h1>
...
async fn fetch_episodes() -> Result<Vec<Episode>, Error> {
    let response = reqwest::get("http://10.0.4.41:7777/theringsofpower").await?;
