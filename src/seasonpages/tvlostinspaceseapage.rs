...
#[component]
pub fn TVLostInSpaceSeaPage() -> impl IntoView {
    ...
    view! {
        <div class="seaMainDiv">
            <h1 class="seaH1">Lost In Space</h1>
