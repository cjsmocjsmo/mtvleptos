...
#[component]
pub fn TVBadBatchSeaPage() -> impl IntoView {
    ...
    view! {
        <div class="seaMainDiv">
            ...
            <div class="seaInnerDiv">
                <h3 class="seaH3">Season 1</h3>
                <div class="seaBtnGrp">
                    {move || episodes3.get().iter().map(|episode: &Episode| view! {
                        <button class="seaBtn">{episode.Episode.clone()}</button>
                    }).collect_view()}
                </div>
            </div>
